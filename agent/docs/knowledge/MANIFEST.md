...
| `error-framework.md` | Mandatory project error framework: framework variables, `FMError.Set`, own application errors, standard response envelope, error logging, and trace propagation across child scripts. Supersedes generic error articles for solution scripts. | error framework, error handling, error capture, FMError, Error.Make, Response.Make, Response.Capture, Trace.Init, trace, call chain, child script, script result, SYS_LogError, errorID, traceID, response envelope |
